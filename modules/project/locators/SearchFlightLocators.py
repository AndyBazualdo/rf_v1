...
class Locators():
    FROM_SELECT = (By.XPATH,"//select[@name='fromPort']/option[@value='{}']")
    TO_SELECT = (By.XPATH,"//select[@name='toPort']/option[@value='{}']")
    # SUBMIT_BUTTON = (By.XPATH,"//input[@type='submit']")
    SUBMIT_BUTTON = (By.CSS_SELECTOR, "input[type='submit']")
    SEARCH_TABLE = (By.XPATH,"//table[@class='table']/tbody/tr")
